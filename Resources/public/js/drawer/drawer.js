...
requirejs.config(
    {
        paths: {
            ...
            'step': '/bundles/idcistep/js/drawer/step',
            'path': '/bundles/idcistep/js/drawer/path',
            'infos': '/bundles/idcistep/js/drawer/infos',
            'endstep': '/bundles/idcistep/js/drawer/endStep',
            'modal': '/bundles/idcistep/js/drawer/modal'
        }
    }
);
